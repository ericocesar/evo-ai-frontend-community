# BChat CRM Frontend — Trademark and Brand Assets Policy

Version 1.0, 2026.05.06

"Evolution Foundation", "Evolution" and "BChat CRM Frontend" are trademarks of
Evolution Foundation. The "evocrm-frontend" wordmark and the BChat CRM Frontend
logo are trademarks of Evolution Foundation.

## 1. Scope and purpose

This policy governs the use of BChat CRM Frontend trademarks and brand assets.
It is intended to protect users from confusion and to preserve the official
BChat CRM Frontend visual identity.

This policy applies to any use of:
(a) the product names and marks "Evolution Foundation", "Evolution" and "BChat CRM Frontend";
...
(d) any materials that implement or express the BChat CRM Frontend official look
...
2.1. You may truthfully refer to BChat CRM Frontend to describe that your software
...
BChat CRM Frontend that include BChat CRM Frontend brand assets, provided that you
comply with Section 3 and do not suggest endorsement beyond being an official
unmodified build.

2.3. You may use BChat CRM Frontend marks in nominative ways, such as
"based on BChat CRM Frontend", provided that the use is accurate and does not
create confusion.

## 3. Protected Visual Identity Elements (Brand Assets)

The following are the "Protected Visual Identity Elements":
(a) Product names and marks: "Evolution Foundation", "Evolution" and "BChat CRM Frontend";
...
BChat CRM Frontend brand assets.** If you distribute or publicly host any version
of the user interface that uses BChat CRM Frontend brand assets, you may not
remove, replace, modify, disable, or bypass any Protected Visual Identity Element.

4.2. **Modified UI must remove BChat CRM Frontend brand assets.**
...
(a) remove and replace all BChat CRM Frontend trademarks and brand assets from
    the user interface, product name display, and related marketing materials
    for that distribution; and
(b) choose a name and branding that are clearly distinct from BChat CRM Frontend.

4.3. **No endorsement.**
You may not use BChat CRM Frontend trademarks or brand assets in a way that
...
BChat CRM Frontend logo or wordmark.
...
Any violation of this policy terminates your permission to use BChat CRM Frontend
brand assets. You must promptly cease use and remove BChat CRM Frontend trademarks
